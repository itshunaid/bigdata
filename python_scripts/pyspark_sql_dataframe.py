...
Original file is located at
    https://colab.research.google.com/drive/14VYq3RRdvNvyHWTLcY_I0SaH7_rERmWG
"""
...
customer_df.filter('age>22').show()
...
customer_df.select(countDistinct("country").alias("Disinct Countries")).show()
